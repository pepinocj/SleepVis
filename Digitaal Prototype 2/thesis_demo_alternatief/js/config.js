...
var config_features = {N:{color:colors_blue_to_red, min:300 , max: 600,type:'heart',active:true},
    meanNN:{color:colors_blue_to_red, min:500 , max: 900,type:'heart',active:true}
    ...
    ,pNN50:{color:colors_blue_to_red, min:0 , max: 1,type:'heart',active:true}
    ...
    ,movement:{color:colors_white_to_red,min:67, max:78,type:'mov',active:false}
    ...
    ,mean_position:{color:colors_body_positions,min:-3.14,max:3.14,type:'mov',active:false}};
...
function add3DPosition(){
    config_features["mean_3D_position"] = {color:colors_body_positions,min:0,max:1,type:'mov',active:false};

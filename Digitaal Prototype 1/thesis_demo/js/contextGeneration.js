...
function generateSubjectiveDetails(feature, container, nrDay){
    var container = container.append("div").attr("id","small_parallel_coordinates");
...
function addSMContext(scales,label,content,container,nrDay){
    ...
    var offset = subjContextSmallMultiples.defaultSmallMultipleValues.width-subjContextSmallMultiples.defaultSmallMultipleValues.rangeMax;
    ...
    chart.append('rect')
        ...
        .attr('width',function(d){ return scales.scaleX(d.value); })
            .on("mouseover", function(d){
                ...
                generateSubjectiveDetails(d.key,verDetail,nrDay);
                small_bar_chart_context(horDetail, d.key);
    ...
    chart.append("text")
        ...
        .attr({'x':function(d){ return scales.scaleX(d.value)-10; },'y':function(d,i){ return scales.scaleY(d.key)+5+(scales.scaleY.range()[1]-scales.scaleY.range()[0])/2; }});

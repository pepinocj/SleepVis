    ...
    function generateSubjectiveSingleDetail(obj, container) {
        ...
        container.text(function (d) {
            ...
            if (d.endDate == d.startDate) {
                return translator[d.status] + ": " + " om " + d.startDate.toLocaleTimeString();
            } else {
                return translator[d.status] + ": duur " + (new Date(d.endDate - d.startDate)).toLocaleTimeString('en-GB', {
                hour: "numeric",
                minute: "numeric"
            }) + " van " + d.startDate.toLocaleTimeString() + " tot " + d.endDate.toLocaleTimeString();
            }

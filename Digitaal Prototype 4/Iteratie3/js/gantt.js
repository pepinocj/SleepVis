...
//        $("#chart").scrollTo({top:'-=100px', left:'+=100'}, 800);
        ...
        d3.selectAll(".dayData").classed("hidden", true);
            ...
            d3.select("#dayInspecting").text(dayData.shown_date);
        ...
        ganttWrapperFunction(allActivities, dayViz, collection_day_data[nrDay].date, new Date(collection_day_data[nrDay].date.getTime() + 24 * 60 * 60 * 1000), nrDay, timeFeatures.brusher.width, 8, 0);

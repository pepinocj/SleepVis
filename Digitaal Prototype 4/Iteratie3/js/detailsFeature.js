...
function visualizeDayMinimized(container,nrDay){
    var dayViz = container.append("div").attr("id","dayVizMini"+nrDay).attr("class","dayViz dayLine dayLine"+nrDay);

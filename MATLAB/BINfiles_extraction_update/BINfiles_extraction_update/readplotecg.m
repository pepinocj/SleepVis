tic;
user='userJOSI';
path=['C:\Users\Josi\Documents\KUL\Thesis\Coding\marchECGData\' user '\Stingray\Data'];
...
%     plot_ecg(PL, Cfg);
    ...
    if numel(num2str(i-2))==1;
        save(['C:\Users\Josi\Documents\KUL\Thesis\Coding\marchECGData\' user '\Stingray\ExtractedData\DATA00' num2str(i-2)], 'Start_date_num','ECG','ACC');
    else
        save(['C:\Users\Josi\Documents\KUL\Thesis\Coding\marchECGData\' user '\Stingray\ExtractedData\DATA0' num2str(i-2)], 'Start_date_num','ECG','ACC');

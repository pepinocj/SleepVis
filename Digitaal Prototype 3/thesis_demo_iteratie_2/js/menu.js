...
function sortOnFeature(feature){
    ...
    if(feature == "SE"){
        ...
        return {day:d, value:collection_day_data[d].smartPhoneData.flattened["TST"]/(d.smartPhoneData.flattened["TST"]+d.smartPhoneData.flattened["TWT"])};
    });
    }else{
        dataPoints= visualizedDays.map(function(d,i){
        return {day:d, value:collection_day_data[d].smartPhoneData.flattened[feature]};
    });
    }

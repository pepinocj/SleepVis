...
var config_features = {N:{color:colors_blue_to_red, min:50 , max: 120,type:'heart',active:true ,name:"bpm"},
    ...
    ,LFnu:{color:colors_blue_to_red,min:0, max:1,type:'heart',active:false,name:"LFnu"}
    ,HFnu:{color:colors_blue_to_red,min:0, max:1,type:'heart',active:false,name:"HFnu"}

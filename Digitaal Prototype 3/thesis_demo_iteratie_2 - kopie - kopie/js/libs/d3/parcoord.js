    ...
    pc.autoscale = function() {
        ...
        var defaultScales = {
            ...
            "number": function(k) {
                ...
                //TODO: CHANGE IN CODE, quick fix
                var qf = {FFT_VLF:{min:0,max:400000},FFT_LF:{min:0,max:200000},FFT_HF:{min:0,max:200000}};
                if(k in qf){
                    extent = [0,qf[k].max]
                }
...
// returns the y-position just beyond the separating null value line
    ...
    function dimensionLabels(d) {
        var result = d in __.dimensionTitles ? __.dimensionTitles[d] : d;  // dimension display names
        
        if(result in config_features){
            return config_features[result]["name"];
        }
    ...
    pc.createAxes = function() {
        ...
        g.append("svg:g")
            ...
            .attr("class",function(d){return "label rowLabel featureName "+d})
